...
export interface VulpesPluginHooks {
     ...
     */
    canShortCircuit?(doc: DocumentContext): Promise<ShortCircuitResult | null> | ShortCircuitResult | null;
    /**
     ...
     */
    postDetection?(spans: SpanLike[], doc: DocumentContext): Promise<SpanLike[]> | SpanLike[];
    /**
     ...
     * @returns Modified span array
     */
    preRedaction?(spans: SpanLike[], doc: DocumentContext): Promise<SpanLike[]> | SpanLike[];
    /**
     ...
     */
    postRedaction?(result: RedactionResultLike): Promise<RedactionResultLike> | RedactionResultLike;
}
/**
 ...
 */
export declare function isPluginV2(plugin: unknown): plugin is VulpesPluginV2;
/**
 * Type guard to check if a plugin uses legacy interface.
 */
export declare function isLegacyPlugin(plugin: unknown): plugin is {
    hooks: LegacyHookPlugin;
};
