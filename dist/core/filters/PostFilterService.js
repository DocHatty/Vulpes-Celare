...
class DevicePhoneFalsePositiveFilter {
    constructor() {
        this.name = "DevicePhoneFalsePositive";
    }
...
SectionHeadingFilter.SECTION_HEADINGS = new Set([
...
SectionHeadingFilter.SINGLE_WORD_HEADINGS = new Set([
    "IMPRESSION",
    "FINDINGS",
    "TECHNIQUE",
    "COMPARISON",
...
StructureWordFilter.STRUCTURE_WORDS = new Set([
    "RECORD",
    "INFORMATION",
    "SECTION",
    "NOTES",
...
InvalidPrefixFilter.INVALID_STARTS = [
    "The ",
    "A ",
    "An ",
    "To ",
...
InvalidSuffixFilter.INVALID_ENDINGS = [
    " the",
    " at",
    " in",
    " on",
...
MedicalPhraseFilter.MEDICAL_PHRASES = new Set([
    "the patient",
    "the doctor",
...
MedicalSuffixFilter.MEDICAL_SUFFIXES = [
    "Disorder",
    "Mellitus",
    "Disease",
    "Syndrome",
...
GeographicTermFilter.GEO_TERMS = new Set([
    "boulder",
    "boston",
    "denver",
    "colorado",
...
FieldLabelFilter.FIELD_LABELS = new Set([
    "spouse name",
    "sister name",
    "brother name",
    "mother name",
