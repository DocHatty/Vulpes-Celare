 ...
 */
FieldLabelWhitelist.WHITELIST_TERMS = new Set([
    // ===== Document Structure =====
    "comprehensive",
    "synthetic",
    "hipaa",
 ...
 */
FieldLabelWhitelist.EXACT_PHRASE_EXCLUSIONS = new Set([
    // Document titles
    "sample body radiology report",
    "radiology report",
    "progress note",
 ...
 */
FieldLabelWhitelist.STRUCTURE_WORDS = new Set([
    "RECORD",
    "INFORMATION",
    "SECTION",
    "NOTES",
 ...
 */
FieldLabelWhitelist.PATTERN_MATCHED_TYPES = new Set([
    "EMAIL",
    "URL",
    "PHONE",
    "FAX",
