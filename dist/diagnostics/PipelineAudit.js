...
exports.PipelineAudit = void 0;
exports.buildAnalysisContext = buildAnalysisContext;
exports.formatAnalysisContext = formatAnalysisContext;
exports.diagnoseFailures = diagnoseFailures;
exports.analyzeFailuresForInvestigation = analyzeFailuresForInvestigation;
exports.runPipelineAudit = runPipelineAudit;
exports.printPipelineAudit = printPipelineAudit;
exports.getMethodologyGuidance = getMethodologyGuidance;
exports.formatCompleteAnalysis = formatCompleteAnalysis;
...
class PipelineAudit {
    ...
    static getCodePath(name, rustAvailable) {
        const paths = {
            overlapResolution: {
                ...
                check: () => RustAccelConfig_1.RustAccelConfig.isSpanOpsEnabled(),
            },
            postFiltering: {
                ...
                check: () => RustAccelConfig_1.RustAccelConfig.isPostFilterEnabled(),
            },
            spanApplication: {
                ...
                check: () => RustAccelConfig_1.RustAccelConfig.isApplySpansEnabled(),
            },
            nameScanning: {
                ...
                check: () => RustAccelConfig_1.RustAccelConfig.getNameAccelMode() > 0,
            },
        };
        const config = paths[name];
        if (!config)
            return { name, implementation: "typescript", file: "unknown", isActive: false };
...
exports.PipelineAudit = PipelineAudit;
// =============================================================================
 ...
 * - Rank priorities
 */
function buildAnalysisContext(failures) {
    ...
    for (const [phiType, typeFailures] of Object.entries(byType)) {
        ...
        const failureRecords = typeFailures.slice(0, 10).map(f => {
            const ctx = f.context || "";
 ...
 */
function analyzeFailuresForInvestigation(failures, _audit) {
 ...
 */
function getMethodologyGuidance() {
    return `
 ...
 */
function formatCompleteAnalysis(context, includeMethodology = true) {
    const lines = [];
...
//# sourceMappingURL=PipelineAudit.js.map