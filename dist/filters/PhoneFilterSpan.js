...
class PhoneFilterSpan extends SpanBasedFilter_1.SpanBasedFilter {
     ...
     */
    static COMPILED_PATTERNS = PhoneFilterSpan.compilePatterns(PhoneFilterSpan.PHONE_PATTERN_SOURCES);
    getType() {
        return "PHONE";
    }
    getPriority() {
        return SpanBasedFilter_1.FilterPriority.PHONE;
    }
    detect(text, _config, context) {
        const accelerated = RustScanKernel_1.RustScanKernel.getDetections(context, text, "PHONE");
        if (accelerated && accelerated.length > 0) {
            return accelerated.map((d) => {
                return SpanFactory_1.SpanFactory.fromPosition(text, d.characterStart, d.characterEnd, Span_1.FilterType.PHONE, {
...
exports.PhoneFilterSpan = PhoneFilterSpan;
//# sourceMappingURL=PhoneFilterSpan.js.map