...
class SSNFilterSpan extends SpanBasedFilter_1.SpanBasedFilter {
     ...
     */
    static COMPILED_PATTERNS = SSNFilterSpan.compilePatterns([
    ...
    detect(text, _config, context) {
        ...
        if (accelerated && accelerated.length > 0) {
            return accelerated.map((d) => {
                return SpanFactory_1.SpanFactory.fromPosition(text, d.characterStart, d.characterEnd, Span_1.FilterType.SSN, {
...
exports.SSNFilterSpan = SSNFilterSpan;
//# sourceMappingURL=SSNFilterSpan.js.map