...
program
    ...
    .alias("da")
    .description("Deep analysis with Opus 4.5/Codex 5.2 High Max after 500+ documents tested")
    ...
    .option("-v, --verbose", "Verbose output")
    .action(async (options) => {
    await CLI_1.CLI.deepAnalyze(options);
});
// ============================================================================
...
program
    ...
    .option("--profile <profile>", "Grading profile: HIPAA_STRICT, DEVELOPMENT", "HIPAA_STRICT")
...
program
    ...
    .action(async (options) => {
    await CLI_1.CLI.diagnose(options);
});
// ============================================================================
