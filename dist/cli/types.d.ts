 ...
 */
export declare function isValidAgentBackend(value: unknown): value is AgentBackend;
/**
 ...
 */
export type ToolInput = RedactTextToolInput | AnalyzeRedactionToolInput | ReadFileToolInput | WriteFileToolInput | RunCommandToolInput | ListFilesToolInput | SearchCodeToolInput | GetSystemInfoToolInput | RunTestsToolInput;
/**
 ...
 * Subagent role types
 */
export type SubagentRole = "redaction_analyst" | "code_analyst" | "validation_agent" | "dictionary_agent" | "research_agent" | "custom";
/**
 ...
 */
export declare function isRedactTextInput(input: unknown): input is RedactTextToolInput;
/**
 * Type guard for ReadFileToolInput
 */
export declare function isReadFileInput(input: unknown): input is ReadFileToolInput;
/**
 * Type guard for WriteFileToolInput
 */
export declare function isWriteFileInput(input: unknown): input is WriteFileToolInput;
/**
 * Type guard for RunCommandToolInput
 */
export declare function isRunCommandInput(input: unknown): input is RunCommandToolInput;
/**
 * Type guard for ListFilesToolInput
 */
export declare function isListFilesInput(input: unknown): input is ListFilesToolInput;
/**
 * Type guard for SearchCodeToolInput
 */
export declare function isSearchCodeInput(input: unknown): input is SearchCodeToolInput;
/**
 * Type guard for RunTestsToolInput
 */
export declare function isRunTestsInput(input: unknown): input is RunTestsToolInput;
