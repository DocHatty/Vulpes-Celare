...
class DocumentVocabulary {
     ...
     */
    static DOCUMENT_STRUCTURE = new Set([
        // Report types
        "radiology report",
        "progress note",
        "discharge summary",
     ...
     */
    static INSURANCE_TERMS = new Set([
        "blue cross",
        "blue shield",
     ...
     */
    static GEOGRAPHIC_TERMS = new Set([
     ...
     */
    static NEVER_NAME_WORDS = new Set([
        // Document structure
        "section",
        "information",
        "record",
        ...
        "full",
        "total",
        // === WIN-WIN ADDITIONS: Reduce false positives ===
        ...
        "supervisor",
        "administrator",
        // Temporal words (not PHI by themselves)
        "daily",
        "weekly",
        "monthly",
        "yearly",
        ...
        "evening",
        "afternoon",
        // Medical role words (often mistaken for names)
        "attending",
        "resident",
        "fellow",
        "intern",
        ...
        "level",
        "degree",
        // Common false positive triggers from test failures
        "timeline",
        "narrative",
        "reference",
        "source",
