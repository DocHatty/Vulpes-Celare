 ...
 * ============================================================================
 */
export { VulpesCelare, VulpesCelareConfig, RedactionResult, RedactionResultWithProvenance, ProvenanceOptions, PHIType, ReplacementStyle, } from "./VulpesCelare";
...
export { shouldWhitelist, isMedicalTerm, isNonPHI, getWhitelistPenalty, } from "./utils/UnifiedMedicalWhitelist";
...
export { BlockchainAnchor, BlockchainAnchorResult, AnchorVerificationResult, AnchorAttestation, AnchorOptions, AnchorStatus, OTS_CALENDAR_SERVERS, anchorToBlockchain, verifyBlockchainAnchor, } from "./provenance/BlockchainAnchor";
export { FHIRAuditEventExporter, FHIRAuditEvent, FHIRAuditEventOptions, FHIRAuditEventAgent, FHIRAuditEventSource, FHIRAuditEventEntity, FHIRAuditEventEntityDetail, FHIRAuditEventOutcome, FHIRCoding, FHIRCodeableConcept, FHIRReference, FHIR_VERSION, RESOURCE_TYPE, } from "./provenance/FHIRAuditEventExporter";
...
export { ExplanationGenerator, RedactionExplanation, ExplanationReport, ConfidenceFactor, } from "./explanations";
export { BaseLLMWrapper, LLMRedactionConfig, RedactionMapping, RedactionAuditEntry, VulpesOpenAI, VulpesOpenAIConfig, OpenAIMessage, OpenAIChatCompletionParams, OpenAIChatCompletionResponse, VulpesAnthropic, VulpesAnthropicConfig, AnthropicMessage, AnthropicContentBlock, AnthropicMessageParams, AnthropicMessageResponse, } from "./llm";
export { DifferentialPrivacy, DifferentialPrivacyConfig, NoisyStatistic, DPRedactionStats, PrivacyPreset, PRIVACY_PRESETS, DPHistogram, PrivacyAccountant, createDifferentialPrivacy, } from "./privacy";
export { VulpesTracer, vulpesTracer, MetricsCollector, configureTracer, type Span as TracerSpan, type SpanContext as TracerSpanContext, type SpanEvent as TracerSpanEvent, type SpanStatus as TracerSpanStatus, type SpanAttributes as TracerSpanAttributes, type TracerConfig, type ExporterType, type ExporterConfig, type TraceContext, type Metric, type MetricValue, } from "./observability/VulpesTracer";
export { SecurityAlertEngine, securityAlertEngine, recordSecurityOperation, type SecurityAlert, type AlertRule, type AlertChannel, type AlertSeverity, type AlertType, type AlertCondition, type AlertDetails, type AlertSource, type SecurityMetrics, type SecurityAlertEngineConfig, type SlackConfig, type WebhookConfig, type EmailConfig, type FileConfig, type ConsoleConfig, } from "./security/SecurityAlertEngine";
export { RetentionPolicyEngine, retentionPolicyEngine, type RetentionPolicy, type LegalHold, type LegalHoldScope, type DestructionCertificate, type RetentionRecord, type ArchiveResult, type PurgeResult, type RetentionPolicyEngineConfig, type DataType, type DestructionMethod, } from "./compliance/RetentionPolicyEngine";
export { VulpesError, ErrorAggregator, createConfigError, createValidationError, createFileError, createSecurityError, createComplianceError, createDetectionError, createPipelineError, createIntegrationError, ERROR_CODES, type VulpesErrorOptions, type ErrorCategory, type ErrorSeverity, type ErrorContext, type ErrorCode, } from "./errors/VulpesError";
export { VulpesEnvironment, vulpesEnvironment, isCI, isTTY, isInteractive, shouldUseColor, getCIProvider, getEnvironmentInfo, type CIProvider, type ColorSupport, type ShellType, type TerminalEmulator, type EnvironmentInfo, } from "./utils/VulpesEnvironment";
export { VulpesAIDebugger, vulpesAIDebugger, type FailureType, type RootCause, type RootCauseCategory, type FixSuggestion, type PatternSuggestion, type TestFailure, type Analysis, type DebugSession, } from "./ai/VulpesAIDebugger";
export { InkComponents, render, renderToOutput, h, Box, Text, Static, Newline, Spacer, ProgressBar, Spinner, Table, type Component, type ComponentProps, type ComponentChild, type BoxProps, type TextProps, type SpinnerProps, type ProgressBarProps, type SelectProps, } from "./ui";
export { PluginManager, pluginManager, type Plugin, type PluginManifest, type PluginInstance, type PluginType, type PluginState, type PluginContext, type PluginManagerConfig, type PluginConfigItem, type FilterPlugin, type FilterMatch, type FormatterPlugin, type ChannelPlugin, type HookPlugin, } from "./plugins";
