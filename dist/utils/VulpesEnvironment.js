...
exports.vulpesEnvironment = exports.VulpesEnvironment = void 0;
exports.isCI = isCI;
exports.isTTY = isTTY;
...
const CI_DETECTORS = [
    {
        ...
        getBranch: () => process.env.GITHUB_HEAD_REF ??
    ...
    },
    {
        ...
        getBranch: () => process.env.CI_MERGE_REQUEST_SOURCE_BRANCH_NAME ??
    ...
    },
    {
        ...
        getBranch: () => process.env.TRAVIS_PULL_REQUEST_BRANCH ??
    ...
    },
    {
        ...
        detect: () => !!process.env.TF_BUILD || !!process.env.AZURE_PIPELINES,
        ...
        getBranch: () => process.env.SYSTEM_PULLREQUEST_SOURCEBRANCH ??
            process.env.BUILD_SOURCEBRANCHNAME ??
            null,
        getCommitSha: () => process.env.BUILD_SOURCEVERSION ?? null,
        getPullRequest: () => process.env.SYSTEM_PULLREQUEST_PULLREQUESTID ?? null,
    },
    {
    ...
    },
    {
        ...
        getBranch: () => process.env.DRONE_SOURCE_BRANCH ??
    ...
    },
    {
        ...
        getBranch: () => process.env.APPVEYOR_PULL_REQUEST_HEAD_REPO_BRANCH ??
...
exports.VulpesEnvironment = VulpesEnvironment;
// ============================================================================
// Singleton Export
// ============================================================================
exports.vulpesEnvironment = VulpesEnvironment.getInstance();
// ============================================================================
// Convenience Functions
// ============================================================================
function isCI() {
    return exports.vulpesEnvironment.isCI;
}
function isTTY() {
    return exports.vulpesEnvironment.isTTY;
}
function isInteractive() {
    return exports.vulpesEnvironment.isInteractive;
}
function shouldUseColor() {
    return exports.vulpesEnvironment.shouldUseColor();
}
function getCIProvider() {
    return exports.vulpesEnvironment.ciProvider;
}
function getEnvironmentInfo() {
    return exports.vulpesEnvironment.getInfo();
}
//# sourceMappingURL=VulpesEnvironment.js.map