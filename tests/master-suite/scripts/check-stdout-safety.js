...
console.error(
  "║  STDOUT SAFETY CHECK - MCP Protocol Protection               ║",
);
console.error(
  "╚══════════════════════════════════════════════════════════════╝\n",
);
...
if (violations.length === 0) {
  ...
  console.error(
    `❌ DANGER: Found ${violations.length} violation(s) that will break MCP!\n`,
  );
  ...
  console.error(
    "     Replace all process.stdout.write with process.stderr.write\n",
  );
