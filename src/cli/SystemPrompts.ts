...
export const CORE_IDENTITY = `You are the Vulpes Celare Agent - an AI assistant specialized in HIPAA PHI redaction development.
...
export const CODEBASE_KNOWLEDGE = `## CODEBASE STRUCTURE
...
export const TARGET_METRICS = `## TARGET METRICS (HIPAA_STRICT Profile)
...
export const MCP_INTEGRATION = `## MCP CORTEX INTEGRATION
...
export const STANDARD_WORKFLOW = `## STANDARD WORKFLOW
...
export const UX_GUIDELINES = `## UX GUIDELINES
...
export const BEHAVIORAL_RULES = `## BEHAVIORAL RULES
 ...
 */
export const SYSTEM_PROMPT_DEV = `${CORE_IDENTITY}
 ...
 */
export const SYSTEM_PROMPT_QA = `${CORE_IDENTITY}
 ...
 */
export const SYSTEM_PROMPT_PRODUCTION = `${CORE_IDENTITY}
 ...
 */
export function getSystemPrompt(mode: 'dev' | 'qa' | 'production'): string {
  switch (mode) {
    case 'dev':
      return SYSTEM_PROMPT_DEV;
    case 'qa':
      return SYSTEM_PROMPT_QA;
    case 'production':
      return SYSTEM_PROMPT_PRODUCTION;
    default:
      return SYSTEM_PROMPT_DEV;
  }
}
 ...
 */
export const SYSTEM_PROMPT_COMPACT = `You are the Vulpes Celare Agent - HIPAA PHI redaction specialist.
