...
import { VisualDetector, VisualDetection, VisualBox } from './VisualDetector';
...
export class ImageRedactor {
    ...
    private textRedactor: ((text: string) => Promise<{ redacted: string; matches: string[] }>) | null = null;
     ...
     */
    setTextRedactor(
        redactor: (text: string) => Promise<{ redacted: string; matches: string[] }>
    ): void {
