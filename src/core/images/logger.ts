 ...
 */
export class ImageServiceLogger extends EventEmitter {
    private static instance: ImageServiceLogger;
     ...
     */
    private updateServiceHealth(service: string, success: boolean, error?: string): void {
     ...
     * Get recent logs
     */
    getRecentLogs(count: number = 50, service?: string, level?: LogLevel): LogEntry[] {
...
export const getLogger = () => ImageServiceLogger.getInstance();
