...
export class FieldLabelWhitelist {
  /**
   * Terms that should NEVER be redacted - they're field labels, not PHI
   */
  private static readonly WHITELIST_TERMS = new Set([
    // ===== Document Structure =====
    "comprehensive",
    "synthetic",
    "hipaa",
   ...
   */
  private static readonly EXACT_PHRASE_EXCLUSIONS = new Set([
    // Document titles
    "sample body radiology report",
    "radiology report",
    "progress note",
   ...
   */
  private static looksLikeStreetAddress(text: string): boolean {
