 ...
 * Set to "0" to disable
 */
export function isBloomFilterEnabled(): boolean {
 ...
 */
export function isSQLiteDictionaryEnabled(): boolean {
 ...
 */
export function isDFAScanEnabled(): boolean {
 ...
 */
export function isZigDFAAccelEnabled(): boolean {
 ...
 */
export function getZigDFAMode(): "shadow" | "primary" | "disabled" {
 ...
 */
export function isGPUBatchEnabled(): boolean {
 ...
 * Default: 10
 */
export function getGPUFallbackThreshold(): number {
 ...
 */
export function isFuzzyAccelEnabled(): boolean {
 ...
 */
export function isPhoneticEnabled(): boolean {
 ...
 * Default: 0.95
 */
export function getPhoneticThreshold(): number {
 ...
 */
export function isStreamKernelEnabled(): boolean {
 ...
 */
export function isStreamDetectionsEnabled(): boolean {
 ...
 */
export function isShadowRustNameEnabled(): boolean {
 ...
 * Set to "1" to enable shadow mode
 */
export function isShadowPostFilterEnabled(): boolean {
 ...
 * Set to "1" to enable shadow mode
 */
export function isShadowApplySpansEnabled(): boolean {
 ...
 */
export function getGlinerModelPath(): string {
 ...
 */
export function getTinyBertModelPath(): string {
 ...
 */
export function getFPClassifierModelPath(): string {
 ...
 */
export function getMLDevice(): "cpu" | "cuda" | "directml" | "coreml" {
 ...
 * Default: 0
 */
export function getMLGPUDeviceId(): number {
 ...
 * Default: "hybrid"
 */
export function getNameDetectionMode(): "hybrid" | "gliner" | "rules" {
