...
- Has annual revenue > $1M USD, AND
- Wants to integrate Vulpes Celare into closed-source/proprietary software
- Wants to offer Vulpes Celare as a managed service without open-sourcing
- Cannot comply with AGPL-3.0's source distribution requirements
...
**Startup Tier** ($1M - $10M annual revenue)
- Base license: Contact for pricing
- Annual renewal
- Standard support
...
**OEM/Embedded Tier**
- For redistribution in products
- Volume-based pricing
- White-label options
- Technical integration support

## Free Use Cases (No Commercial License Needed)

Even if your organization has > $1M revenue, you DON'T need a commercial license if:
- Using Vulpes Celare internally (not as a service to customers)
- Willing to open source your entire application under AGPL-3.0
- Non-profit healthcare organization

## Contact

For commercial licensing inquiries:
- GitHub: https://github.com/DocHatty/Vulpes-Celare/issues
- Create issue with label: `commercial-license`
...
We believe in open source AND sustainability:
- **Open source**: Code is auditable (critical for HIPAA PHI handling)
- **Free for small orgs**: Startups, researchers, non-profits benefit freely
- **Paid for large orgs**: Enterprise pays for closed-source use (funds development)

This model ensures the project remains:
